...
<head>
    ...
    <title>Connexion à WhiteListManager</title>
                    ...
                    <div class="card-body">
                        <form class="form-example" action="" method="post">
                            <center>
                                ...
                                <h3>Connexion à WhiteListManager</<h3></h3>
                        ...
                        <?php } ?>
                          ...
                          <!-- End input fields -->
                          <p class="copyright" align="center">WhiteListManager &copy; 2023 made by Muzan.</p>
                        </form>
                        <!-- Form end -->
                    </div>
                </div>
